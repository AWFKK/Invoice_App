...
class PdfInvoicePage {
  ...
  static Future<File> generate(Invoice invoice, String invoiceName) async {
    ...
    return Pdf.saveDocument(name: 'InstaDoor_Invoice'+ invoiceName +'.pdf', pdf: pdf);
  }

  //QR Code Generated By Invoice number (invoice.info.number)
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: 'Pay by', value: "Card"),
        ],
      );
